...
const TYPE_MOCK = ['taxi', 'bus', 'train', 'ship', 'drive', 'flight', 'check-in', 'sightseeing', 'restaurant'];
...
export {BASE_PRICE_MOCK, DATE_FROM_MOCK, DATE_TO_MOCK, TYPE_MOCK, NAME_MOCK, WAYPOINT_COUNT, DEFAULT_WAY_POINT};
